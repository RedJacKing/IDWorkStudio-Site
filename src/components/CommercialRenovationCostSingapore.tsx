...
const articleContent = {
  ...
  cost_summary: {
    office: { title: "Office renovation", range: "$80 – $150 psf", note: "Many SME office fit-outs with partition, electrical, flooring and basic carpentry." },
  ...
  faqs: {
    "1": { q: "How much does commercial renovation cost in Singapore?", a: "Many SME office renovations fall around $80 to $150 psf. Retail renovation often ranges from $120 to $300 psf. F&B renovation can reach $200 to $500+ psf because of exhaust, plumbing, grease trap, kitchen and fire safety requirements." },
  ...
  quick_p1: "新加坡商业翻新费用中，许多中小型办公室装修通常约为 <strong>每平方英尺 $80 至 $150</strong>，但最终预算很大程度取决于业态、大厦规定与审批要求。零售店、诊所与餐饮单位通常更高，因为装修不只是做室内效果，还必须支持实际营运、合规、机电服务与业主要求。",
  ...
  cost_summary: {
    office: { title: "办公室翻新", range: "$80 – $150 psf", note: "适用于许多中小型办公室，包括隔墙、电工、地板与基础木工。" },
  ...
  faq_title: "商业翻新常见问题",
  faqs: {
    "1": { q: "新加坡商业翻新费用是多少？", a: "许多中小型办公室翻新通常约 $80 至 $150 psf。零售翻新常见为 $120 至 $300 psf。餐饮翻新可能达到 $200 至 $500+ psf，因为涉及排烟、给排水、隔油池、厨房与消防安全要求。" },
