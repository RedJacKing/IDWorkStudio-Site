...
const shophouseRenoContent = {
  ...
  hero: {
    ...
    b2: "BCA & SCDF Coordination Where Required",
...
faq: {
  ...
  zh: {
  hero: { badge:"新加坡 URA 保育店屋翻新专家", serif:"店屋翻新", bold:"专业之选", subtitle:"为新加坡店屋协调URA保育许可证流程，并在适用时协调BCA结构与SCDF消防安全要求。专注于丹戎巴葛、牛车水、甘榜格南及驳船码头地区。", cta:"获取免费咨询", b1:"URA 保育许可证", b2:"按需要协调 BCA 及 SCDF 要求", b3:"审批流程协调" },
