          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">{t(`${p}.overview.p3`)}</p>
              </div>
              <div className="grid grid-cols-1 gap-4">
                <div className="bg-off-white border border-gray-100 rounded-xl p-6">
                  <h3 className="font-bold text-dark-charcoal mb-3 uppercase tracking-wide text-sm">{t(`${p}.overview.districts_title`)}</h3>
                ...
                <div className="bg-off-white border border-gray-100 rounded-xl p-6">
                  <h3 className="font-bold text-dark-charcoal mb-2 uppercase tracking-wide text-sm">{t(`${p}.overview.uses_title`)}</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">{t(`${p}.overview.uses_desc`)}</p>
                </div>
              </div>
            </div>
          </div>
