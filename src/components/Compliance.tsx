    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-sans font-bold mb-4 text-charcoal">Project Management & Compliance</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 border border-gray-100 rounded-xl hover:shadow-lg transition-shadow bg-off-white">
            ...
            <h3 className="text-xl font-sans font-bold mb-3 text-charcoal">Fire Safety (SCDF)</h3>
          ...
          <div className="p-8 border border-gray-100 rounded-xl hover:shadow-lg transition-shadow bg-off-white">
            ...
            <h3 className="text-xl font-sans font-bold mb-3 text-charcoal">BCA & HDB Permits</h3>
            <p className="text-charcoal/70 text-sm leading-relaxed">
          ...
          <div className="p-8 border border-gray-100 rounded-xl hover:shadow-lg transition-shadow bg-off-white">
            ...
            <h3 className="text-xl font-sans font-bold mb-3 text-charcoal">Mall Management</h3>
            <p className="text-charcoal/70 text-sm leading-relaxed">
