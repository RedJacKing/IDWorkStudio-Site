          ...
          <div className="space-y-6 font-sans">
            {[
              ...
              },
              {
                ...
                a: "As an HDB-licensed (HB-02-5250G) and BCA-registered contractor, we ensure fire sprinklers, smoke detectors, and emergency lighting are reinstated to their original as-built positions to pass landlord and building management inspections."
              },
              {
