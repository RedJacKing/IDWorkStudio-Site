...
const content: Record<"en" | "zh", ArticleContent> = {
  "en": {
    "metaTitle": "Office Reinstatement Singapore: Cost, Timeline, Checklist & Landlord Requirements (2026 Guide) | ID Work Studio",
    "metaDescription": "A practical Singapore office reinstatement guide covering cost, timeline, landlord handover requirements, checklist, hidden costs, security deposit risks and commercial lease planning.",
    "canonical": "https://idworkstudio.com/insights/office-reinstatement-singapore",
    "eyebrow": "Commercial Lease Handover Guide",
    "title": "Office Reinstatement Singapore: Cost, Timeline, Checklist & Landlord Requirements",
    ...
    "sections": [
      {
        "eyebrow": "Definition",
        "title": "What is office reinstatement in Singapore?",
        "paragraphs": [
    ...
    "faqs": [
      {
        "question": "Is office reinstatement mandatory in Singapore?",
      ...
      {
        "question": "How much does office reinstatement cost in Singapore?",
